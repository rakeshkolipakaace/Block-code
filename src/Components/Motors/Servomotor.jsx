  ...
  return (
    <div
      style={{
        ...
        border: `2px solid ${selected ? "#2563eb" : "#e5e7eb"}`, // Blue border for Servo
        padding: "12px",
        width: "256px",
        minHeight: "180px",
        position: "relative",
    ...
    >
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          <label style={{ fontSize: "12px", color: "#6b7280" }}>Angle</label>
          <input
            type="number"
            min="0"
            max="180"
            value={data.angle || ""}
            onChange={(e) => handleDataChange("angle", e.target.value)}
            placeholder="0 - 180°"
            style={{
